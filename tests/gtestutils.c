...
void
gfbgraph_test_fixture_setup (GFBGraphTestFixture *fixture,
...
static void
gfbgraph_test_fixture_teardown (GFBGraphTestFixture         *fixture,
...
static void
gfbgraph_test_me (GFBGraphTestFixture         *fixture,
                  G_GNUC_UNUSED gconstpointer  user_data)
{
  GFBGraphUser *me;
  GError *error = NULL;
...
static void
gfbgraph_test_album (GFBGraphTestFixture         *fixture,
                     G_GNUC_UNUSED gconstpointer  user_data)
{
  GFBGraphUser *me;
  GFBGraphAlbum *album;
